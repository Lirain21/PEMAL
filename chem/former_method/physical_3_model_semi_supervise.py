...
def train(args, vdss_model, t1_2_model, cl_model,  para_loss, para_function_cl_vdss_t1_2, para_function_auc_cl,  device, loader, optimizer, epoch, train_labeled_loader, train_unlabel_iterator): # para_contrastive_loss,
    vdss_model.train()
    t1_2_model.train()
    cl_model.train()
...
def main():
    ...
    for args.runseed in [1, 2, 3, 4, 5]:
        ...
        unlabel_loader = DataLoader(unlabel_dataset, batch_size= int(10.0 * args.batch_size), shuffle=True, num_workers = args.num_workers)
        ...
        for epoch in range(1, args.epochs+1):
            ...
            train_auc_label, train_cl_label, train_vdss_label, train_t1_2_label = train(args, vdss_model, t1_2_model, cl_model, para_loss, para_function_cl_vdss_t1_2, para_function_auc_cl, device, train_loader, optimizer, epoch, train_loader, train_unlabeled_iterator) # para_contrastive_loss,
            ...
            auc_val_loss, cl_val_loss, vdss_val_loss, t1_2_val_loss, all_loss, \
                ...
                valid_auc_label, valid_cl_label, valid_vdss_label, valid_t1_2_label = eval(args, vdss_model, t1_2_model, cl_model, para_loss, para_function_cl_vdss_t1_2, para_function_auc_cl, device, val_loader, epoch) # para_contrastive_loss,
    ...
    print('mean_val_mse_loss',mean_val_mse_loss)
